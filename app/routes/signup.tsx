...
import { registerUser, createUserSession, getUserFromRequest } from "~/lib/auth.server";

export const meta: MetaFunction = () => {
  return [
    { title: "Sign Up - KidsEmotion" },
    { name: "description", content: "Create your KidsEmotion account" },
  ];
};
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  if (!email || !password || !name || !email.trim().endsWith("@gmail.com")) {
  ...
  const children = childName && childAge ? [{ name: childName, age: parseInt(childAge) }] : [];
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-300 via-purple-300 to-indigo-400 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          {/* Sign Up Form */}
          <div className="bg-white/20 backdrop-blur-md rounded-3xl p-8 border-4 border-white/30 shadow-2xl w-full max-w-2xl animate-scale-in">
            <Form method="post" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Parent Information */}
                <div className="space-y-4">
                  <h3 className="text-white font-fun font-bold text-xl mb-4 flex items-center gap-2">
                  ...
                  {/* Name Field */}
                  <div>
                    <label htmlFor="name" className="text-white font-fun font-bold text-lg mb-2 flex items-center gap-2">
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="text-white font-fun font-bold text-lg mb-2 flex items-center gap-2">
                ...
                <div className="space-y-4">
                  ...
                  {/* Child Name Field */}
                  <div>
                    <label htmlFor="childName" className="text-white font-fun font-bold text-lg mb-2 flex items-center gap-2">
                  ...
                  {/* Child Age Field */}
                  <div>
                    <label htmlFor="childAge" className="text-white font-fun font-bold text-lg mb-2 flex items-center gap-2">
                  ...
                  {/* Info Box */}
                  <div className="bg-gradient-to-r from-blue-400/30 to-purple-400/30 rounded-2xl p-4 border-4 border-blue-300/50">
                    <p className="text-white font-semibold text-sm flex items-center gap-2">
                      <span className="text-xl animate-pulse">💡</span>
                      Adding child info helps us provide better content recommendations!
                    </p>
                  </div>
                </div>
              </div>
